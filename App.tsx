  ...
  return (
    <div className="min-h-screen bg-bf-black text-white font-sans selection:bg-bf-gold selection:text-black">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <footer className="mt-20 border-t border-white/10 pt-12 pb-12 text-center space-y-4">
          <p className="text-gray-500 text-sm">⚠️ 注意：折扣信息仅供参考，具体价格以官方页面为准。</p>
          <a 
            href="https://github.com/zifeixu85/BF2025"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-gray-500 hover:text-bf-gold transition-colors text-sm"
          >
